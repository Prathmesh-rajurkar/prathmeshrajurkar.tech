    ...
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-12">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <p className="dark:text-neutral-400 text-neutral-600 mt-4 text-sm sm:text-base max-w-lg">
          Skills I utilize to effectively complete tasks and build modern web
          applications.
        </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-10">
        {skillsData.map((skill) => (
          <div
            key={skill.name}
            className="group flex flex-col items-center justify-center gap-2 p-4 rounded-lg transition-all duration-300 hover:bg-zinc-100 dark:hover:bg-neutral-800"
          >
            <div
